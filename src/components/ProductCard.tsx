      ...
      <div className="bg-white border border-gray-300 rounded-lg overflow-hidden hover:border-gray-400 transition-colors">
        ...
        <div className="p-4">
          <div className="flex items-center gap-1 mb-2">
            ...
            <span className="text-xs text-gray-400 ml-1">({Math.floor(Math.random() * 200) + 50} reviews)</span>
          </div>
          
          <h3 className="font-semibold text-gray-900 mb-1 line-clamp-2">{product.name}</h3>
          <p className="text-sm text-gray-500 mb-2">{product.material} • {product.color}</p>
